...
from ansible_collections.smabot.hvtest.plugins.module_utils._auth_method_approle import HashiVaultAuthMethodApprole
from ansible_collections.smabot.hvtest.plugins.module_utils._auth_method_aws_iam import HashiVaultAuthMethodAwsIam
from ansible_collections.smabot.hvtest.plugins.module_utils._auth_method_azure import HashiVaultAuthMethodAzure
from ansible_collections.smabot.hvtest.plugins.module_utils._auth_method_cert import HashiVaultAuthMethodCert
from ansible_collections.smabot.hvtest.plugins.module_utils._auth_method_jwt import HashiVaultAuthMethodJwt
from ansible_collections.smabot.hvtest.plugins.module_utils._auth_method_ldap import HashiVaultAuthMethodLdap
from ansible_collections.smabot.hvtest.plugins.module_utils._auth_method_none import HashiVaultAuthMethodNone
from ansible_collections.smabot.hvtest.plugins.module_utils._auth_method_token import HashiVaultAuthMethodToken
from ansible_collections.smabot.hvtest.plugins.module_utils._auth_method_userpass import HashiVaultAuthMethodUserpass
