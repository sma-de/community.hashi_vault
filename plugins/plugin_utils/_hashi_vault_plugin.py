...
from ansible_collections.smabot.hvtest.plugins.module_utils._connection_options import HashiVaultConnectionOptions
from ansible_collections.smabot.hvtest.plugins.module_utils._authenticator import HashiVaultAuthenticator
